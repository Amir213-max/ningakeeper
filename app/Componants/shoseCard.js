...
export default function ShoseCard() {
...
<div className="bg-gray-100 hover:bg-gray-200 text-[#666666]  shadow-md overflow-hidden flex flex-col   ">
              <div className="relative w-full h-full   flex items-center justify-center">
                         
    <div  className="splide shose">
      <div className="splide__track">
        <ul className="splide__list">
          <li className="splide__slide grid justify-center ">
            <img src="/assets/shose.webp?text=Slide+1"  alt="Slide 1" />
          </li>
          <li className="splide__slide  grid justify-center">
            <img src="/assets/shose2.webp?text=Slide+2" alt="Slide 2" />
          </li>
          <li className="splide__slide  grid justify-center">
            <img src="/assets/shose.webp?text=Slide+3" alt="Slide 3" />
          </li>
        </ul>
      </div>
    </div>
